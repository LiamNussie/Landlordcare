...
import Bg from '../../assets/manager.svg';
...
const ManagerProfile = () => {
    ...
    return (
        <div className="manager-profile">
            <div className="pic-mapm"  style={{backgroundImage: `url(${Bg})`}}>
                {/* <div className="picx">
            ...
            <div className="down-content">
                <div className="overviewy">
                    <div className="otop">
                        <div className="otopl">
                            <p className="name">Akowonjo Golden Estate</p>
                            <p className="codel">Cities in Operation</p>
                            <ul className="clist">
                                <li>Lagos</li>
                                <li>Ogun</li>
                                <li>Enugu</li>
                    ...
                    <div className="rate-rankx">
                        <div className="rank">
                            <p className="rrtop">Deals in Property Type</p>
                            <p className="rrbtm">Commercial; Residential</p>
                        </div>
                        <div className="rank">
                            <p className="rrtop">Experiences</p>
                            <p className="rrbtm">12 Years</p>
                        </div>
                        <div className="rating">
                            <div className="rtop">4.4 <img src={Stars} alt="stars" /></div>
                ...
                <div className="localityx">
                    ...
                    <br />
                    <br /> */}
                    {/* <p className="title">Landlord Care Properties</p> */}

                    <p className="title">About Landlord Care Propeties</p>
                ...
                <div className="buy-dealsy">
                    <div className="tttop">
                        <p className="titleb">Projects and Properties by Landlord Care Properties</p>
                ...
                <div className="builders">
                    <div className="lgtop">
                        <p className="lgtitle">Other Builders</p>
